    ...
    return(
        ...
        <div className="form experience">
            ...
            <div className="input-box">
                ...
                <input type="text"  style={{ width: '50%', marginLeft: '1.3rem' }} value={from} onChange={e=>updateData(id,'from',e.target.value)}/>
                <span className="details" style={{ marginLeft: '1rem', width: '20%' }} >To</span>
                <input type="text"  style={{ width: '50%', marginLeft: '0' }} value={to} onChange={e=>updateData(id,'to',e.target.value)}/>
            </div>
            <div className="input-box">
